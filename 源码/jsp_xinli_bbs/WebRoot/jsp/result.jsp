	...
	<div id="content" class="center">
	   ...
	   <div>
	     <%
	     	...
	     	if (key == null)
	     		return;
	     	String encodeKey=new String(key.getBytes("UTF-8"),"UTF-8");
	     	...
	     	if (ps.size() == 0) {
	     		...
	     		for (Post p : ps) {
	     			...
	     			out.print("<img src='/xinli_bbs/images/" + u.getUser_icon() + "' width='36px' height='36px'>");
	     ...
	     <p class="p_head" style="margin-top:20px">为您找到用户</p>
	       <%
	     	...
	     	if (uu.size() == 0) {
	     		...
	     		for (User ur : uu) {
	     			out.print("<div class='today_p_wrap'>");
	     			out.print("<img src='/xinli_bbs/images/" + ur.getUser_icon() + "' width='36px' height='36px'>");
	     			out.print("<p class='today_p u_p'>");
	     			out.print("&nbsp;<a href='/xinli_bbs/jsp/userdetail.jsp?uid=" +ur.getUser_id()+ "'>");
